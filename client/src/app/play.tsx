import { AspectRatio, Box, Text, Link, Heading, Hidden, HStack, Stack, VStack, Button, Center, ChevronUpIcon, Avatar, Input, ChevronRightIcon, CloseIcon, useColorMode, IconButton, SunIcon, MoonIcon } from 'native-base';
                            ...
                            <HStack key={Math.random()} width="full" justifyContent="flex-end" alignItems="flex-end" py="5" px="6" _dark={{ borderTopColor: "gray.700" }} _light={{ borderTopColor: "gray.400" }} borderTopWidth="1">
                                ...
                                <VStack width="85%">
                                    <HStack width="full" justifyContent="space-between">
                                        <Text _dark={{ color: "gray.50" }} _light={{ color: "gray.700" }} fontWeight="medium" fontSize="sm" underline pb="1">{name}</Text>
                                        <Text _dark={{ color: "gray.500" }} _light={{ color: "gray.400" }} fontWeight="medium" fontSize="sm" pb="1">{time}</Text>
                                    </HStack>
                                    <Box>
            ...
            {(show !== null) ?
                <Stack direction="column" height="full" _dark={{ bg: "muted.900" }} _light={{ bg: "gray.50" }} width={["full", "full", "full", "3/5", "4/6"]}>
                    ...
                    <VStack width="full" position="relative" px="2">
                        ...
                        {isOpen ? <VStack position="absolute" width="full" _dark={{ bg: "muted.900" }} _light={{ bg: "gray.50" }} py="3" pt="0">
